...
import { Facebook, Linkedin, Twitter, Instagram, Mail, Phone, MapPin, Lock } from "lucide-react";
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href={`tel:${c.contact.phone.replace(/\s/g, "")}`} className="hover:text-primary transition-colors">{c.contact.phone}</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-border">
        <div className="container-custom py-6 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link to="/admin/login" className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-primary transition-colors">
              <Lock size={11} /> Admin
            </Link>
          </div>
        </div>
